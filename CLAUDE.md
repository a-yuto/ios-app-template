...
- `test` (Build + Unit Test + XCUITest を1ジョブで実行)
...
#### 2. Build for testing (CI: `test` ジョブの Build ステップと同等)
...
#### 3. Unit Test (CI: `test` ジョブの Run unit tests ステップと同等)
...
#### 4. UI / E2E Test (CI: `test` ジョブの Run UI tests ステップと同等)
